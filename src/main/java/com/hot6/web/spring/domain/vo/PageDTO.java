...
public class PageDTO {
    ...
    public com.example.app.domain.vo.PageDTO createPageDTO(Criteria criteria, int total){
        return createPageDTO(criteria, total, 10);
    }

    public com.example.app.domain.vo.PageDTO createPageDTO(Criteria criteria, int total, int pageCount){
